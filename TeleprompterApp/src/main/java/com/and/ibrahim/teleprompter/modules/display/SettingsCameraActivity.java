...
import com.and.ibrahim.teleprompter.modules.adapter.FeedbackMailTask;
...
public class SettingsCameraActivity extends AppCompatActivity {
   ...
   // TextView uploadFolderMsg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(getResources().getString(R.string.videoSettings));
        }
       ...
       // switchOnDropbox = (CheckBox) findViewById(R.id.switchOnDropbox);
        ...
        videoResolutionParent = (LinearLayout)findViewById(R.id.videoResolutionParent);
    ...
    View.OnClickListener videoResolutionParentListener = new View.OnClickListener(){
        ...
        public void onClick(View view) {
            ...
            Intent videoSettings = new Intent(getApplicationContext(), VideoResolutionActivity.class);
    ...
    public void updateSettingsValues(){
        ...
        //Video Resolution
        String selRes = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString(Contract.SELECT_VIDEO_RESOLUTION, null);
        if(VERBOSE) Log.d(TAG, "SELECTED VIDEO RES PREF MGR = "+selRes);
        //Photo Resolution
        selRes = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getString(Contract.SELECT_PHOTO_RESOLUTION, null);
        if(VERBOSE) Log.d(TAG, "SELECTED PIC RES PREF MGR = "+selRes);
        //Memory consumed
        boolean memCon = PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).getBoolean(Contract.SHOW_MEMORY_CONSUMED_MSG, false);
...
//--------------------------------------------------------------------------------------------------
    ...
    public void showMemoryConsumed(View view){
        Intent memoryAct = new Intent(SettingsCameraActivity.this, MemoryLimitActivity.class);
