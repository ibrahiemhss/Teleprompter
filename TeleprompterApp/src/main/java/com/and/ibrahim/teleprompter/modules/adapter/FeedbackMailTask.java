...
import com.and.ibrahim.teleprompter.modules.display.SettingsCameraActivity;
...
public class FeedbackMailTask extends AsyncTask<String, Void, Void> {
        ...
        Context mContext;
    SettingsCameraActivity settingsActivity;
        public FeedbackMailTask(Context context, AppCompatActivity appCompatActivity) {
            super();
            mContext = context;
            settingsActivity = (SettingsCameraActivity)appCompatActivity;
        }
